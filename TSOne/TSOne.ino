// Teensy 3.2
// MUX 16
// 16 Analog Potentiometer In's
// Needs 'MIDI Library by Forty Seven Effects'
...
#include <Wire.h>
#include <SPI.h>
//#include <SD.h>   // TODO: Can I remove this?
...
// Multiplexor No of Control
#define MnumControls 16   // TODO: Check that pin 15 is usable and not needed by "EN"
...
AudioConnection          patchCord(waveform3, 0, mixer1, 3);
...
void setup() {
  ...
  // TODO: May have to change the switches to INPUT as the have 3.3v power
  pinMode(SWosc1, INPUT_PULLUP);
  pinMode(SWosc2, INPUT_PULLUP);
  pinMode(SWosc3, INPUT_PULLUP);
...
void oscPlay(byte note) {
  ...
  waveform3.frequency(noteFreqs[note + octave3] * bendFactor * LFOpitch);
...
void oscSet() {
  ...
  waveform3.frequency(noteFreqs[globalNote + octave3] * bendFactor * LFOpitch);
}
...
void myControlChange(byte channel, byte control, byte value) {
  switch (control) {
    ...
    // TODO: I dont think that this is used in the new ersion with octave switches
    case CCoctave:
      switch (value) {
        case 0:
          octave2 = 24;
    ...
    if (muxRead > (muxValues[muxInput] + 7) || muxRead < (muxValues[muxInput] - 7)) {
      ...
      switch (muxInput) {
        ...
        case MUXmix3:
          ...
          break;
        case MUXmix4:
          myControlChange(0, CCmixer4, muxRead);
          break;
        case MUXattack:
